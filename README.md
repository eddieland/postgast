...
BSD-licensed Python bindings to [libpg_query](https://github.com/pganalyze/libpg_query), the PostgreSQL parser extracted as a standalone C library.

Parse, deparse, normalize, fingerprint, and split PostgreSQL SQL statements from Python with zero dependencies beyond the vendored C library.
...
`libpg_query` is licensed under the [BSD 3-Clause License](https://github.com/pganalyze/libpg_query/blob/17-latest/LICENSE). Portions of the PostgreSQL source code used by `libpg_query` are licensed under the [PostgreSQL License](https://www.postgresql.org/about/licence/).
