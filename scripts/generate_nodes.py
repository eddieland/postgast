...
def _generate_base() -> str:
    """Generate base.py content: AstNode, empty _REGISTRY, helper functions, wrap."""
...
def generate() -> dict[str, str]:
    ...
    Returns:
        A dict mapping filename to content (e.g. {"base.py": "...", "_generated.py": "...", "__init__.py": "..."}).
    """
...
def main() -> None:
    ...
    # Clean stale files from previous generator versions (letter-split _*.py files, old _base.py)
    ...
    print(f"  {len(files)} files (base.py, _generated.py, __init__.py)")
