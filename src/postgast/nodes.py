...
class AlterDatabaseSetStmt(AstNode):
    ...
    def setstmt(self) -> VariableSetStmt | None:
        return VariableSetStmt(self._pb.setstmt) if self._pb.HasField("setstmt") else None
...
class AlterDefaultPrivilegesStmt(AstNode):
    ...
    def action(self) -> GrantStmt | None:
        return GrantStmt(self._pb.action) if self._pb.HasField("action") else None
...
class AlterFunctionStmt(AstNode):
    ...
    def func(self) -> ObjectWithArgs | None:
        return ObjectWithArgs(self._pb.func) if self._pb.HasField("func") else None
...
class AlterObjectDependsStmt(AstNode):
    ...
    def relation(self) -> RangeVar | None:
        return RangeVar(self._pb.relation) if self._pb.HasField("relation") else None
    ...
    def extname(self) -> String | None:
        return String(self._pb.extname) if self._pb.HasField("extname") else None
...
class AlterOperatorStmt(AstNode):
    ...
    def opername(self) -> ObjectWithArgs | None:
        return ObjectWithArgs(self._pb.opername) if self._pb.HasField("opername") else None
...
class AlterOwnerStmt(AstNode):
    ...
    def newowner(self) -> RoleSpec | None:
        return RoleSpec(self._pb.newowner) if self._pb.HasField("newowner") else None
...
class AlterPolicyStmt(AstNode):
    ...
    def table(self) -> RangeVar | None:
        return RangeVar(self._pb.table) if self._pb.HasField("table") else None
...
class AlterRoleSetStmt(AstNode):
    ...
    def role(self) -> RoleSpec | None:
        return RoleSpec(self._pb.role) if self._pb.HasField("role") else None
...
class AlterSeqStmt(AstNode):
    ...
    def sequence(self) -> RangeVar | None:
        return RangeVar(self._pb.sequence) if self._pb.HasField("sequence") else None
...
class AlterUserMappingStmt(AstNode):
    ...
    def user(self) -> RoleSpec | None:
        return RoleSpec(self._pb.user) if self._pb.HasField("user") else None
...
class CallStmt(AstNode):
    ...
    def funccall(self) -> FuncCall | None:
        return FuncCall(self._pb.funccall) if self._pb.HasField("funccall") else None

    @property
    def funcexpr(self) -> FuncExpr | None:
        return FuncExpr(self._pb.funcexpr) if self._pb.HasField("funcexpr") else None
...
class ColumnDef(AstNode):
    ...
    def type_name(self) -> TypeName | None:
        return TypeName(self._pb.type_name) if self._pb.HasField("type_name") else None
    ...
    def identity_sequence(self) -> RangeVar | None:
        return RangeVar(self._pb.identity_sequence) if self._pb.HasField("identity_sequence") else None
    ...
    def coll_clause(self) -> CollateClause | None:
        return CollateClause(self._pb.coll_clause) if self._pb.HasField("coll_clause") else None
...
class CommonTableExpr(AstNode):
    ...
    def search_clause(self) -> CTESearchClause | None:
        return CTESearchClause(self._pb.search_clause) if self._pb.HasField("search_clause") else None

    @property
    def cycle_clause(self) -> CTECycleClause | None:
        return CTECycleClause(self._pb.cycle_clause) if self._pb.HasField("cycle_clause") else None
...
class CompositeTypeStmt(AstNode):
    ...
    def typevar(self) -> RangeVar | None:
        return RangeVar(self._pb.typevar) if self._pb.HasField("typevar") else None
...
class Constraint(AstNode):
    ...
    def pktable(self) -> RangeVar | None:
        return RangeVar(self._pb.pktable) if self._pb.HasField("pktable") else None
...
class CreateCastStmt(AstNode):
    ...
    def sourcetype(self) -> TypeName | None:
        return TypeName(self._pb.sourcetype) if self._pb.HasField("sourcetype") else None

    @property
    def targettype(self) -> TypeName | None:
        return TypeName(self._pb.targettype) if self._pb.HasField("targettype") else None
...
class CreateForeignTableStmt(AstNode):
    ...
    def base_stmt(self) -> CreateStmt | None:
        return CreateStmt(self._pb.base_stmt) if self._pb.HasField("base_stmt") else None
...
class CreateFunctionStmt(AstNode):
    ...
    def return_type(self) -> TypeName | None:
        return TypeName(self._pb.return_type) if self._pb.HasField("return_type") else None
...
class CreateOpClassItem(AstNode):
    ...
    def name(self) -> ObjectWithArgs | None:
        return ObjectWithArgs(self._pb.name) if self._pb.HasField("name") else None
    ...
    def storedtype(self) -> TypeName | None:
        return TypeName(self._pb.storedtype) if self._pb.HasField("storedtype") else None
...
class CreateOpClassStmt(AstNode):
    ...
    def datatype(self) -> TypeName | None:
        return TypeName(self._pb.datatype) if self._pb.HasField("datatype") else None
...
class CreateSchemaStmt(AstNode):
    ...
    def authrole(self) -> RoleSpec | None:
        return RoleSpec(self._pb.authrole) if self._pb.HasField("authrole") else None
...
class CreateStmt(AstNode):
    ...
    def partbound(self) -> PartitionBoundSpec | None:
        return PartitionBoundSpec(self._pb.partbound) if self._pb.HasField("partbound") else None

    @property
    def partspec(self) -> PartitionSpec | None:
        return PartitionSpec(self._pb.partspec) if self._pb.HasField("partspec") else None

    @property
    def of_typename(self) -> TypeName | None:
        return TypeName(self._pb.of_typename) if self._pb.HasField("of_typename") else None
...
class CreateTableAsStmt(AstNode):
    ...
    def into(self) -> IntoClause | None:
        return IntoClause(self._pb.into) if self._pb.HasField("into") else None
...
class CreateTableSpaceStmt(AstNode):
    ...
    def owner(self) -> RoleSpec | None:
        return RoleSpec(self._pb.owner) if self._pb.HasField("owner") else None
...
class CreateTransformStmt(AstNode):
    ...
    def fromsql(self) -> ObjectWithArgs | None:
        return ObjectWithArgs(self._pb.fromsql) if self._pb.HasField("fromsql") else None

    @property
    def tosql(self) -> ObjectWithArgs | None:
        return ObjectWithArgs(self._pb.tosql) if self._pb.HasField("tosql") else None
...
class CreateTrigStmt(AstNode):
    ...
    def constrrel(self) -> RangeVar | None:
        return RangeVar(self._pb.constrrel) if self._pb.HasField("constrrel") else None
...
class DeleteStmt(AstNode):
    ...
    def with_clause(self) -> WithClause | None:
        return WithClause(self._pb.with_clause) if self._pb.HasField("with_clause") else None
...
class FuncCall(AstNode):
    ...
    def over(self) -> WindowDef | None:
        return WindowDef(self._pb.over) if self._pb.HasField("over") else None
...
class FunctionParameter(AstNode):
    ...
    def arg_type(self) -> TypeName | None:
        return TypeName(self._pb.arg_type) if self._pb.HasField("arg_type") else None
...
class GrantRoleStmt(AstNode):
    ...
    def grantor(self) -> RoleSpec | None:
        return RoleSpec(self._pb.grantor) if self._pb.HasField("grantor") else None
...
class InsertStmt(AstNode):
    ...
    def on_conflict_clause(self) -> OnConflictClause | None:
        return OnConflictClause(self._pb.on_conflict_clause) if self._pb.HasField("on_conflict_clause") else None
...
class IntoClause(AstNode):
    ...
    def rel(self) -> RangeVar | None:
        return RangeVar(self._pb.rel) if self._pb.HasField("rel") else None
...
class JoinExpr(AstNode):
    ...
    def join_using_alias(self) -> Alias | None:
        return Alias(self._pb.join_using_alias) if self._pb.HasField("join_using_alias") else None
    ...
    def alias(self) -> Alias | None:
        return Alias(self._pb.alias) if self._pb.HasField("alias") else None
...
class JsonAggConstructor(AstNode):
    ...
    def output(self) -> JsonOutput | None:
        return JsonOutput(self._pb.output) if self._pb.HasField("output") else None
...
class JsonArgument(AstNode):
    ...
    def val(self) -> JsonValueExpr | None:
        return JsonValueExpr(self._pb.val) if self._pb.HasField("val") else None
...
class JsonArrayAgg(AstNode):
    ...
    def constructor(self) -> JsonAggConstructor | None:
        return JsonAggConstructor(self._pb.constructor) if self._pb.HasField("constructor") else None

    @property
    def arg(self) -> JsonValueExpr | None:
        return JsonValueExpr(self._pb.arg) if self._pb.HasField("arg") else None
...
class JsonArrayQueryConstructor(AstNode):
    ...
    def format(self) -> JsonFormat | None:
        return JsonFormat(self._pb.format) if self._pb.HasField("format") else None
...
class JsonConstructorExpr(AstNode):
    ...
    def returning(self) -> JsonReturning | None:
        return JsonReturning(self._pb.returning) if self._pb.HasField("returning") else None
...
class JsonExpr(AstNode):
    ...
    def on_empty(self) -> JsonBehavior | None:
        return JsonBehavior(self._pb.on_empty) if self._pb.HasField("on_empty") else None

    @property
    def on_error(self) -> JsonBehavior | None:
        return JsonBehavior(self._pb.on_error) if self._pb.HasField("on_error") else None
...
class JsonFuncExpr(AstNode):
    ...
    def context_item(self) -> JsonValueExpr | None:
        return JsonValueExpr(self._pb.context_item) if self._pb.HasField("context_item") else None
...
class JsonKeyValue(AstNode):
    ...
    def value(self) -> JsonValueExpr | None:
        return JsonValueExpr(self._pb.value) if self._pb.HasField("value") else None
...
class JsonObjectAgg(AstNode):
    ...
    def arg(self) -> JsonKeyValue | None:
        return JsonKeyValue(self._pb.arg) if self._pb.HasField("arg") else None
...
class JsonParseExpr(AstNode):
    ...
    def expr(self) -> JsonValueExpr | None:
        return JsonValueExpr(self._pb.expr) if self._pb.HasField("expr") else None
...
class JsonTable(AstNode):
    ...
    def pathspec(self) -> JsonTablePathSpec | None:
        return JsonTablePathSpec(self._pb.pathspec) if self._pb.HasField("pathspec") else None
...
class JsonTablePathScan(AstNode):
    ...
    def path(self) -> JsonTablePath | None:
        return JsonTablePath(self._pb.path) if self._pb.HasField("path") else None
...
class OnConflictClause(AstNode):
    ...
    def infer(self) -> InferClause | None:
        return InferClause(self._pb.infer) if self._pb.HasField("infer") else None
...
class PLAssignStmt(AstNode):
    ...
    def val(self) -> SelectStmt | None:
        return SelectStmt(self._pb.val) if self._pb.HasField("val") else None
...
class ParseResult(AstNode):
    ...
    def stmts(self) -> list[RawStmt]:
        return [RawStmt(item) for item in self._pb.stmts]
...
class PartitionCmd(AstNode):
    ...
    def name(self) -> RangeVar | None:
        return RangeVar(self._pb.name) if self._pb.HasField("name") else None

    @property
    def bound(self) -> PartitionBoundSpec | None:
        return PartitionBoundSpec(self._pb.bound) if self._pb.HasField("bound") else None
...
class PublicationObjSpec(AstNode):
    ...
    def pubtable(self) -> PublicationTable | None:
        return PublicationTable(self._pb.pubtable) if self._pb.HasField("pubtable") else None
...
class Query(AstNode):
    ...
    def jointree(self) -> FromExpr | None:
        return FromExpr(self._pb.jointree) if self._pb.HasField("jointree") else None
    ...
    def on_conflict(self) -> OnConflictExpr | None:
        return OnConflictExpr(self._pb.on_conflict) if self._pb.HasField("on_conflict") else None
...
class RangeTblEntry(AstNode):
    ...
    def eref(self) -> Alias | None:
        return Alias(self._pb.eref) if self._pb.HasField("eref") else None
    ...
    def tablesample(self) -> TableSampleClause | None:
        return TableSampleClause(self._pb.tablesample) if self._pb.HasField("tablesample") else None

    @property
    def subquery(self) -> Query | None:
        return Query(self._pb.subquery) if self._pb.HasField("subquery") else None
    ...
    def tablefunc(self) -> TableFunc | None:
        return TableFunc(self._pb.tablefunc) if self._pb.HasField("tablefunc") else None
...
class ReassignOwnedStmt(AstNode):
    ...
    def newrole(self) -> RoleSpec | None:
        return RoleSpec(self._pb.newrole) if self._pb.HasField("newrole") else None
...
class ScanResult(AstNode):
    ...
    def tokens(self) -> list[ScanToken]:
        return [ScanToken(item) for item in self._pb.tokens]
...
class SelectStmt(AstNode):
    ...
    def into_clause(self) -> IntoClause | None:
        return IntoClause(self._pb.into_clause) if self._pb.HasField("into_clause") else None
    ...
    def larg(self) -> SelectStmt | None:
        return SelectStmt(self._pb.larg) if self._pb.HasField("larg") else None

    @property
    def rarg(self) -> SelectStmt | None:
        return SelectStmt(self._pb.rarg) if self._pb.HasField("rarg") else None
...
class SummaryResult(AstNode):
    ...
    def tables(self) -> list[SummaryResult_Table]:
        return [SummaryResult_Table(item) for item in self._pb.tables]

    @property
    def aliases(self) -> list[SummaryResult_AliasesEntry]:
        return [SummaryResult_AliasesEntry(item) for item in self._pb.aliases]
    ...
    def functions(self) -> list[SummaryResult_Function]:
        return [SummaryResult_Function(item) for item in self._pb.functions]

    @property
    def filter_columns(self) -> list[SummaryResult_FilterColumn]:
        return [SummaryResult_FilterColumn(item) for item in self._pb.filter_columns]
...
class ViewStmt(AstNode):
    ...
    def view(self) -> RangeVar | None:
        return RangeVar(self._pb.view) if self._pb.HasField("view") else None
