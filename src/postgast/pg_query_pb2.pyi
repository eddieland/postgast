...
class JsonQuotes(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    JSON_QUOTES_UNDEFINED: _ClassVar[JsonQuotes]
    JS_QUOTES_UNSPEC: _ClassVar[JsonQuotes]
    JS_QUOTES_KEEP: _ClassVar[JsonQuotes]
    JS_QUOTES_OMIT: _ClassVar[JsonQuotes]

class JsonTableColumnType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    JSON_TABLE_COLUMN_TYPE_UNDEFINED: _ClassVar[JsonTableColumnType]
    JTC_FOR_ORDINALITY: _ClassVar[JsonTableColumnType]
    JTC_REGULAR: _ClassVar[JsonTableColumnType]
    JTC_EXISTS: _ClassVar[JsonTableColumnType]
    JTC_FORMATTED: _ClassVar[JsonTableColumnType]
    JTC_NESTED: _ClassVar[JsonTableColumnType]
...
class TableFuncType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    TABLE_FUNC_TYPE_UNDEFINED: _ClassVar[TableFuncType]
...
class JsonConstructorType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    JSCTOR_JSON_PARSE: _ClassVar[JsonConstructorType]
    JSCTOR_JSON_SCALAR: _ClassVar[JsonConstructorType]
    JSCTOR_JSON_SERIALIZE: _ClassVar[JsonConstructorType]
...
class JsonWrapper(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    JSON_WRAPPER_UNDEFINED: _ClassVar[JsonWrapper]
    JSW_UNSPEC: _ClassVar[JsonWrapper]
    JSW_NONE: _ClassVar[JsonWrapper]
    JSW_CONDITIONAL: _ClassVar[JsonWrapper]
    JSW_UNCONDITIONAL: _ClassVar[JsonWrapper]

class JsonBehaviorType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    JSON_BEHAVIOR_TYPE_UNDEFINED: _ClassVar[JsonBehaviorType]
    JSON_BEHAVIOR_NULL: _ClassVar[JsonBehaviorType]
    JSON_BEHAVIOR_ERROR: _ClassVar[JsonBehaviorType]
    JSON_BEHAVIOR_EMPTY: _ClassVar[JsonBehaviorType]
    JSON_BEHAVIOR_TRUE: _ClassVar[JsonBehaviorType]
    JSON_BEHAVIOR_FALSE: _ClassVar[JsonBehaviorType]
    JSON_BEHAVIOR_UNKNOWN: _ClassVar[JsonBehaviorType]
    JSON_BEHAVIOR_EMPTY_ARRAY: _ClassVar[JsonBehaviorType]
    JSON_BEHAVIOR_EMPTY_OBJECT: _ClassVar[JsonBehaviorType]
    JSON_BEHAVIOR_DEFAULT: _ClassVar[JsonBehaviorType]

class JsonExprOp(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    JSON_EXPR_OP_UNDEFINED: _ClassVar[JsonExprOp]
    JSON_EXISTS_OP: _ClassVar[JsonExprOp]
    JSON_QUERY_OP: _ClassVar[JsonExprOp]
    JSON_VALUE_OP: _ClassVar[JsonExprOp]
    JSON_TABLE_OP: _ClassVar[JsonExprOp]
...
class MergeMatchKind(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    MERGE_MATCH_KIND_UNDEFINED: _ClassVar[MergeMatchKind]
    MERGE_WHEN_MATCHED: _ClassVar[MergeMatchKind]
    MERGE_WHEN_NOT_MATCHED_BY_SOURCE: _ClassVar[MergeMatchKind]
    MERGE_WHEN_NOT_MATCHED_BY_TARGET: _ClassVar[MergeMatchKind]
...
class Token(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    JSON_EXISTS: _ClassVar[Token]
    JSON_OBJECT: _ClassVar[Token]
    JSON_OBJECTAGG: _ClassVar[Token]
    JSON_QUERY: _ClassVar[Token]
    JSON_SCALAR: _ClassVar[Token]
    JSON_SERIALIZE: _ClassVar[Token]
    JSON_TABLE: _ClassVar[Token]
    JSON_VALUE: _ClassVar[Token]
    KEEP: _ClassVar[Token]
    KEY: _ClassVar[Token]
...
JS_QUOTES_OMIT: JsonQuotes
JSON_TABLE_COLUMN_TYPE_UNDEFINED: JsonTableColumnType
JTC_FOR_ORDINALITY: JsonTableColumnType
JTC_REGULAR: JsonTableColumnType
JTC_EXISTS: JsonTableColumnType
JTC_FORMATTED: JsonTableColumnType
JTC_NESTED: JsonTableColumnType
...
JSCTOR_JSON_PARSE: JsonConstructorType
JSCTOR_JSON_SCALAR: JsonConstructorType
JSCTOR_JSON_SERIALIZE: JsonConstructorType
...
JSON_WRAPPER_UNDEFINED: JsonWrapper
JSW_UNSPEC: JsonWrapper
JSW_NONE: JsonWrapper
JSW_CONDITIONAL: JsonWrapper
JSW_UNCONDITIONAL: JsonWrapper
JSON_BEHAVIOR_TYPE_UNDEFINED: JsonBehaviorType
JSON_BEHAVIOR_NULL: JsonBehaviorType
JSON_BEHAVIOR_ERROR: JsonBehaviorType
JSON_BEHAVIOR_EMPTY: JsonBehaviorType
JSON_BEHAVIOR_TRUE: JsonBehaviorType
JSON_BEHAVIOR_FALSE: JsonBehaviorType
JSON_BEHAVIOR_UNKNOWN: JsonBehaviorType
JSON_BEHAVIOR_EMPTY_ARRAY: JsonBehaviorType
JSON_BEHAVIOR_EMPTY_OBJECT: JsonBehaviorType
JSON_BEHAVIOR_DEFAULT: JsonBehaviorType
JSON_EXPR_OP_UNDEFINED: JsonExprOp
JSON_EXISTS_OP: JsonExprOp
JSON_QUERY_OP: JsonExprOp
JSON_VALUE_OP: JsonExprOp
JSON_TABLE_OP: JsonExprOp
...
MERGE_MATCH_KIND_UNDEFINED: MergeMatchKind
MERGE_WHEN_MATCHED: MergeMatchKind
MERGE_WHEN_NOT_MATCHED_BY_SOURCE: MergeMatchKind
MERGE_WHEN_NOT_MATCHED_BY_TARGET: MergeMatchKind
...
class ParseResult(_message.Message):
    ...
    def __init__(self, version: _Optional[int] = ..., stmts: _Optional[_Iterable[_Union[RawStmt, _Mapping]]] = ...) -> None: ...
...
class Node(_message.Message):
    ...
    WINDOW_FUNC_RUN_CONDITION_FIELD_NUMBER: _ClassVar[int]
    MERGE_SUPPORT_FUNC_FIELD_NUMBER: _ClassVar[int]
    ...
    JSON_BEHAVIOR_FIELD_NUMBER: _ClassVar[int]
    JSON_EXPR_FIELD_NUMBER: _ClassVar[int]
    JSON_TABLE_PATH_FIELD_NUMBER: _ClassVar[int]
    JSON_TABLE_PATH_SCAN_FIELD_NUMBER: _ClassVar[int]
    JSON_TABLE_SIBLING_JOIN_FIELD_NUMBER: _ClassVar[int]
    ...
    JSON_FUNC_EXPR_FIELD_NUMBER: _ClassVar[int]
    JSON_TABLE_PATH_SPEC_FIELD_NUMBER: _ClassVar[int]
    JSON_TABLE_FIELD_NUMBER: _ClassVar[int]
    JSON_TABLE_COLUMN_FIELD_NUMBER: _ClassVar[int]
    JSON_KEY_VALUE_FIELD_NUMBER: _ClassVar[int]
    JSON_PARSE_EXPR_FIELD_NUMBER: _ClassVar[int]
    JSON_SCALAR_EXPR_FIELD_NUMBER: _ClassVar[int]
    JSON_SERIALIZE_EXPR_FIELD_NUMBER: _ClassVar[int]
...
class A_Const(_message.Message):
    ...
    isnull: bool
    location: int
    def __init__(self, ival: _Optional[_Union[Integer, _Mapping]] = ..., fval: _Optional[_Union[Float, _Mapping]] = ..., boolval: _Optional[_Union[Boolean, _Mapping]] = ..., sval: _Optional[_Union[String, _Mapping]] = ..., bsval: _Optional[_Union[BitString, _Mapping]] = ..., isnull: bool = ..., location: _Optional[int] = ...) -> None: ...
...
class TableFunc(_message.Message):
    ...
    FUNCTYPE_FIELD_NUMBER: _ClassVar[int]
    ...
    COLVALEXPRS_FIELD_NUMBER: _ClassVar[int]
    PASSINGVALEXPRS_FIELD_NUMBER: _ClassVar[int]
    ...
    colvalexprs: _containers.RepeatedCompositeFieldContainer[Node]
    passingvalexprs: _containers.RepeatedCompositeFieldContainer[Node]
    notnulls: _containers.RepeatedScalarFieldContainer[int]
    plan: Node
    ordinalitycol: int
    location: int
    def __init__(self, functype: _Optional[_Union[TableFuncType, str]] = ..., ns_uris: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., ns_names: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., docexpr: _Optional[_Union[Node, _Mapping]] = ..., rowexpr: _Optional[_Union[Node, _Mapping]] = ..., colnames: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., coltypes: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., coltypmods: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., colcollations: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., colexprs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., coldefexprs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., colvalexprs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., passingvalexprs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., notnulls: _Optional[_Iterable[int]] = ..., plan: _Optional[_Union[Node, _Mapping]] = ..., ordinalitycol: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...

class IntoClause(_message.Message):
    __slots__ = ("rel", "col_names", "access_method", "options", "on_commit", "table_space_name", "view_query", "skip_data")
...
class Param(_message.Message):
    ...
    paramcollid: int
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., paramkind: _Optional[_Union[ParamKind, str]] = ..., paramid: _Optional[int] = ..., paramtype: _Optional[int] = ..., paramtypmod: _Optional[int] = ..., paramcollid: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...

class Aggref(_message.Message):
    __slots__ = ("xpr", "aggfnoid", "aggtype", "aggcollid", "inputcollid", "aggargtypes", "aggdirectargs", "args", "aggorder", "aggdistinct", "aggfilter", "aggstar", "aggvariadic", "aggkind", "agglevelsup", "aggsplit", "aggno", "aggtransno", "location")
    XPR_FIELD_NUMBER: _ClassVar[int]
    ...
    aggtransno: int
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., aggfnoid: _Optional[int] = ..., aggtype: _Optional[int] = ..., aggcollid: _Optional[int] = ..., inputcollid: _Optional[int] = ..., aggargtypes: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., aggdirectargs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., aggorder: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., aggdistinct: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., aggfilter: _Optional[_Union[Node, _Mapping]] = ..., aggstar: bool = ..., aggvariadic: bool = ..., aggkind: _Optional[str] = ..., agglevelsup: _Optional[int] = ..., aggsplit: _Optional[_Union[AggSplit, str]] = ..., aggno: _Optional[int] = ..., aggtransno: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...
...
class GroupingFunc(_message.Message):
    ...
    agglevelsup: int
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., refs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., agglevelsup: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...

class WindowFunc(_message.Message):
    __slots__ = ("xpr", "winfnoid", "wintype", "wincollid", "inputcollid", "args", "aggfilter", "run_condition", "winref", "winstar", "winagg", "location")
    XPR_FIELD_NUMBER: _ClassVar[int]
    ...
    winagg: bool
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., winfnoid: _Optional[int] = ..., wintype: _Optional[int] = ..., wincollid: _Optional[int] = ..., inputcollid: _Optional[int] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., aggfilter: _Optional[_Union[Node, _Mapping]] = ..., run_condition: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., winref: _Optional[int] = ..., winstar: bool = ..., winagg: bool = ..., location: _Optional[int] = ...) -> None: ...

class WindowFuncRunCondition(_message.Message):
    __slots__ = ("xpr", "opno", "inputcollid", "wfunc_left", "arg")
    XPR_FIELD_NUMBER: _ClassVar[int]
    OPNO_FIELD_NUMBER: _ClassVar[int]
    INPUTCOLLID_FIELD_NUMBER: _ClassVar[int]
    WFUNC_LEFT_FIELD_NUMBER: _ClassVar[int]
    ...
    wfunc_left: bool
    arg: Node
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., opno: _Optional[int] = ..., inputcollid: _Optional[int] = ..., wfunc_left: bool = ..., arg: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...

class MergeSupportFunc(_message.Message):
    __slots__ = ("xpr", "msftype", "msfcollid", "location")
    XPR_FIELD_NUMBER: _ClassVar[int]
    MSFTYPE_FIELD_NUMBER: _ClassVar[int]
    MSFCOLLID_FIELD_NUMBER: _ClassVar[int]
    LOCATION_FIELD_NUMBER: _ClassVar[int]
    xpr: Node
    msftype: int
    msfcollid: int
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., msftype: _Optional[int] = ..., msfcollid: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...

class SubscriptingRef(_message.Message):
    __slots__ = ("xpr", "refcontainertype", "refelemtype", "refrestype", "reftypmod", "refcollid", "refupperindexpr", "reflowerindexpr", "refexpr", "refassgnexpr")
    XPR_FIELD_NUMBER: _ClassVar[int]
    ...
    refexpr: Node
    refassgnexpr: Node
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., refcontainertype: _Optional[int] = ..., refelemtype: _Optional[int] = ..., refrestype: _Optional[int] = ..., reftypmod: _Optional[int] = ..., refcollid: _Optional[int] = ..., refupperindexpr: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., reflowerindexpr: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., refexpr: _Optional[_Union[Node, _Mapping]] = ..., refassgnexpr: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...

class FuncExpr(_message.Message):
    __slots__ = ("xpr", "funcid", "funcresulttype", "funcretset", "funcvariadic", "funcformat", "funccollid", "inputcollid", "args", "location")
    XPR_FIELD_NUMBER: _ClassVar[int]
    ...
    args: _containers.RepeatedCompositeFieldContainer[Node]
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., funcid: _Optional[int] = ..., funcresulttype: _Optional[int] = ..., funcretset: bool = ..., funcvariadic: bool = ..., funcformat: _Optional[_Union[CoercionForm, str]] = ..., funccollid: _Optional[int] = ..., inputcollid: _Optional[int] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class NamedArgExpr(_message.Message):
    ...
    argnumber: int
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., name: _Optional[str] = ..., argnumber: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...
...
class OpExpr(_message.Message):
    ...
    args: _containers.RepeatedCompositeFieldContainer[Node]
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., opno: _Optional[int] = ..., opresulttype: _Optional[int] = ..., opretset: bool = ..., opcollid: _Optional[int] = ..., inputcollid: _Optional[int] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class ScalarArrayOpExpr(_message.Message):
    ...
    args: _containers.RepeatedCompositeFieldContainer[Node]
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., opno: _Optional[int] = ..., use_or: bool = ..., inputcollid: _Optional[int] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class BoolExpr(_message.Message):
    ...
    args: _containers.RepeatedCompositeFieldContainer[Node]
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., boolop: _Optional[_Union[BoolExprType, str]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class SubLink(_message.Message):
    ...
    subselect: Node
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., sub_link_type: _Optional[_Union[SubLinkType, str]] = ..., sub_link_id: _Optional[int] = ..., testexpr: _Optional[_Union[Node, _Mapping]] = ..., oper_name: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., subselect: _Optional[_Union[Node, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...

class SubPlan(_message.Message):
    __slots__ = ("xpr", "sub_link_type", "testexpr", "param_ids", "plan_id", "plan_name", "first_col_type", "first_col_typmod", "first_col_collation", "use_hash_table", "unknown_eq_false", "parallel_safe", "set_param", "par_param", "args", "startup_cost", "per_call_cost")
    XPR_FIELD_NUMBER: _ClassVar[int]
    SUB_LINK_TYPE_FIELD_NUMBER: _ClassVar[int]
    TESTEXPR_FIELD_NUMBER: _ClassVar[int]
    ...
    startup_cost: float
    per_call_cost: float
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., sub_link_type: _Optional[_Union[SubLinkType, str]] = ..., testexpr: _Optional[_Union[Node, _Mapping]] = ..., param_ids: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., plan_id: _Optional[int] = ..., plan_name: _Optional[str] = ..., first_col_type: _Optional[int] = ..., first_col_typmod: _Optional[int] = ..., first_col_collation: _Optional[int] = ..., use_hash_table: bool = ..., unknown_eq_false: bool = ..., parallel_safe: bool = ..., set_param: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., par_param: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., startup_cost: _Optional[float] = ..., per_call_cost: _Optional[float] = ...) -> None: ...
...
class AlternativeSubPlan(_message.Message):
    ...
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., subplans: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class FieldSelect(_message.Message):
    ...
    resulttypmod: int
    resultcollid: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., fieldnum: _Optional[int] = ..., resulttype: _Optional[int] = ..., resulttypmod: _Optional[int] = ..., resultcollid: _Optional[int] = ...) -> None: ...
...
class FieldStore(_message.Message):
    ...
    resulttype: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., newvals: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., fieldnums: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., resulttype: _Optional[int] = ...) -> None: ...
...
class RelabelType(_message.Message):
    ...
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., resulttype: _Optional[int] = ..., resulttypmod: _Optional[int] = ..., resultcollid: _Optional[int] = ..., relabelformat: _Optional[_Union[CoercionForm, str]] = ..., location: _Optional[int] = ...) -> None: ...
...
class CoerceViaIO(_message.Message):
    ...
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., resulttype: _Optional[int] = ..., resultcollid: _Optional[int] = ..., coerceformat: _Optional[_Union[CoercionForm, str]] = ..., location: _Optional[int] = ...) -> None: ...
...
class ArrayCoerceExpr(_message.Message):
    ...
    coerceformat: CoercionForm
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., elemexpr: _Optional[_Union[Node, _Mapping]] = ..., resulttype: _Optional[int] = ..., resulttypmod: _Optional[int] = ..., resultcollid: _Optional[int] = ..., coerceformat: _Optional[_Union[CoercionForm, str]] = ..., location: _Optional[int] = ...) -> None: ...
...
class ConvertRowtypeExpr(_message.Message):
    ...
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., resulttype: _Optional[int] = ..., convertformat: _Optional[_Union[CoercionForm, str]] = ..., location: _Optional[int] = ...) -> None: ...
...
class CollateExpr(_message.Message):
    ...
    coll_oid: int
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., coll_oid: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...
...
class CaseExpr(_message.Message):
    ...
    defresult: Node
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., casetype: _Optional[int] = ..., casecollid: _Optional[int] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., defresult: _Optional[_Union[Node, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class CaseWhen(_message.Message):
    ...
    result: Node
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., expr: _Optional[_Union[Node, _Mapping]] = ..., result: _Optional[_Union[Node, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class CoalesceExpr(_message.Message):
    ...
    args: _containers.RepeatedCompositeFieldContainer[Node]
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., coalescetype: _Optional[int] = ..., coalescecollid: _Optional[int] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class MinMaxExpr(_message.Message):
    ...
    args: _containers.RepeatedCompositeFieldContainer[Node]
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., minmaxtype: _Optional[int] = ..., minmaxcollid: _Optional[int] = ..., inputcollid: _Optional[int] = ..., op: _Optional[_Union[MinMaxOp, str]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class SQLValueFunction(_message.Message):
    ...
    typmod: int
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., op: _Optional[_Union[SQLValueFunctionOp, str]] = ..., type: _Optional[int] = ..., typmod: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...

class XmlExpr(_message.Message):
    __slots__ = ("xpr", "op", "name", "named_args", "arg_names", "args", "xmloption", "indent", "type", "typmod", "location")
    XPR_FIELD_NUMBER: _ClassVar[int]
    OP_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    typmod: int
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., op: _Optional[_Union[XmlExprOp, str]] = ..., name: _Optional[str] = ..., named_args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., arg_names: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., xmloption: _Optional[_Union[XmlOptionType, str]] = ..., indent: bool = ..., type: _Optional[int] = ..., typmod: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...
...
class JsonFormat(_message.Message):
    ...
    location: int
    def __init__(self, format_type: _Optional[_Union[JsonFormatType, str]] = ..., encoding: _Optional[_Union[JsonEncoding, str]] = ..., location: _Optional[int] = ...) -> None: ...
...
class JsonReturning(_message.Message):
    ...
    typid: int
    typmod: int
    def __init__(self, format: _Optional[_Union[JsonFormat, _Mapping]] = ..., typid: _Optional[int] = ..., typmod: _Optional[int] = ...) -> None: ...
...
class JsonValueExpr(_message.Message):
    ...
    formatted_expr: Node
    format: JsonFormat
    def __init__(self, raw_expr: _Optional[_Union[Node, _Mapping]] = ..., formatted_expr: _Optional[_Union[Node, _Mapping]] = ..., format: _Optional[_Union[JsonFormat, _Mapping]] = ...) -> None: ...
...
class JsonConstructorExpr(_message.Message):
    ...
    unique: bool
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., type: _Optional[_Union[JsonConstructorType, str]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., func: _Optional[_Union[Node, _Mapping]] = ..., coercion: _Optional[_Union[Node, _Mapping]] = ..., returning: _Optional[_Union[JsonReturning, _Mapping]] = ..., absent_on_null: bool = ..., unique: bool = ..., location: _Optional[int] = ...) -> None: ...
...
class JsonIsPredicate(_message.Message):
    ...
    unique_keys: bool
    location: int
    def __init__(self, expr: _Optional[_Union[Node, _Mapping]] = ..., format: _Optional[_Union[JsonFormat, _Mapping]] = ..., item_type: _Optional[_Union[JsonValueType, str]] = ..., unique_keys: bool = ..., location: _Optional[int] = ...) -> None: ...

class JsonBehavior(_message.Message):
    __slots__ = ("btype", "expr", "coerce", "location")
    BTYPE_FIELD_NUMBER: _ClassVar[int]
    EXPR_FIELD_NUMBER: _ClassVar[int]
    COERCE_FIELD_NUMBER: _ClassVar[int]
    LOCATION_FIELD_NUMBER: _ClassVar[int]
    btype: JsonBehaviorType
    expr: Node
    coerce: bool
    location: int
    def __init__(self, btype: _Optional[_Union[JsonBehaviorType, str]] = ..., expr: _Optional[_Union[Node, _Mapping]] = ..., coerce: bool = ..., location: _Optional[int] = ...) -> None: ...

class JsonExpr(_message.Message):
    __slots__ = ("xpr", "op", "column_name", "formatted_expr", "format", "path_spec", "returning", "passing_names", "passing_values", "on_empty", "on_error", "use_io_coercion", "use_json_coercion", "wrapper", "omit_quotes", "collation", "location")
    XPR_FIELD_NUMBER: _ClassVar[int]
    OP_FIELD_NUMBER: _ClassVar[int]
    COLUMN_NAME_FIELD_NUMBER: _ClassVar[int]
    FORMATTED_EXPR_FIELD_NUMBER: _ClassVar[int]
    FORMAT_FIELD_NUMBER: _ClassVar[int]
    PATH_SPEC_FIELD_NUMBER: _ClassVar[int]
    RETURNING_FIELD_NUMBER: _ClassVar[int]
    PASSING_NAMES_FIELD_NUMBER: _ClassVar[int]
    PASSING_VALUES_FIELD_NUMBER: _ClassVar[int]
    ON_EMPTY_FIELD_NUMBER: _ClassVar[int]
    ON_ERROR_FIELD_NUMBER: _ClassVar[int]
    USE_IO_COERCION_FIELD_NUMBER: _ClassVar[int]
    USE_JSON_COERCION_FIELD_NUMBER: _ClassVar[int]
    WRAPPER_FIELD_NUMBER: _ClassVar[int]
    OMIT_QUOTES_FIELD_NUMBER: _ClassVar[int]
    COLLATION_FIELD_NUMBER: _ClassVar[int]
    LOCATION_FIELD_NUMBER: _ClassVar[int]
    xpr: Node
    op: JsonExprOp
    ...
    path_spec: Node
    returning: JsonReturning
    passing_names: _containers.RepeatedCompositeFieldContainer[Node]
    passing_values: _containers.RepeatedCompositeFieldContainer[Node]
    ...
    collation: int
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., op: _Optional[_Union[JsonExprOp, str]] = ..., column_name: _Optional[str] = ..., formatted_expr: _Optional[_Union[Node, _Mapping]] = ..., format: _Optional[_Union[JsonFormat, _Mapping]] = ..., path_spec: _Optional[_Union[Node, _Mapping]] = ..., returning: _Optional[_Union[JsonReturning, _Mapping]] = ..., passing_names: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., passing_values: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., on_empty: _Optional[_Union[JsonBehavior, _Mapping]] = ..., on_error: _Optional[_Union[JsonBehavior, _Mapping]] = ..., use_io_coercion: bool = ..., use_json_coercion: bool = ..., wrapper: _Optional[_Union[JsonWrapper, str]] = ..., omit_quotes: bool = ..., collation: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...

class JsonTablePath(_message.Message):
    __slots__ = ("name",)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
    def __init__(self, name: _Optional[str] = ...) -> None: ...

class JsonTablePathScan(_message.Message):
    __slots__ = ("plan", "path", "error_on_error", "child", "col_min", "col_max")
    PLAN_FIELD_NUMBER: _ClassVar[int]
    PATH_FIELD_NUMBER: _ClassVar[int]
    ERROR_ON_ERROR_FIELD_NUMBER: _ClassVar[int]
    CHILD_FIELD_NUMBER: _ClassVar[int]
    COL_MIN_FIELD_NUMBER: _ClassVar[int]
    COL_MAX_FIELD_NUMBER: _ClassVar[int]
    plan: Node
    path: JsonTablePath
    error_on_error: bool
    child: Node
    col_min: int
    col_max: int
    def __init__(self, plan: _Optional[_Union[Node, _Mapping]] = ..., path: _Optional[_Union[JsonTablePath, _Mapping]] = ..., error_on_error: bool = ..., child: _Optional[_Union[Node, _Mapping]] = ..., col_min: _Optional[int] = ..., col_max: _Optional[int] = ...) -> None: ...

class JsonTableSiblingJoin(_message.Message):
    __slots__ = ("plan", "lplan", "rplan")
    PLAN_FIELD_NUMBER: _ClassVar[int]
    LPLAN_FIELD_NUMBER: _ClassVar[int]
    RPLAN_FIELD_NUMBER: _ClassVar[int]
    plan: Node
    lplan: Node
    rplan: Node
    def __init__(self, plan: _Optional[_Union[Node, _Mapping]] = ..., lplan: _Optional[_Union[Node, _Mapping]] = ..., rplan: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...
...
class NullTest(_message.Message):
    ...
    argisrow: bool
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., nulltesttype: _Optional[_Union[NullTestType, str]] = ..., argisrow: bool = ..., location: _Optional[int] = ...) -> None: ...
...
class BooleanTest(_message.Message):
    ...
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., booltesttype: _Optional[_Union[BoolTestType, str]] = ..., location: _Optional[int] = ...) -> None: ...

class MergeAction(_message.Message):
    __slots__ = ("match_kind", "command_type", "override", "qual", "target_list", "update_colnos")
    ...
    def __init__(self, match_kind: _Optional[_Union[MergeMatchKind, str]] = ..., command_type: _Optional[_Union[CmdType, str]] = ..., override: _Optional[_Union[OverridingKind, str]] = ..., qual: _Optional[_Union[Node, _Mapping]] = ..., target_list: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., update_colnos: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class CoerceToDomain(_message.Message):
    ...
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., resulttype: _Optional[int] = ..., resulttypmod: _Optional[int] = ..., resultcollid: _Optional[int] = ..., coercionformat: _Optional[_Union[CoercionForm, str]] = ..., location: _Optional[int] = ...) -> None: ...
...
class CoerceToDomainValue(_message.Message):
    ...
    collation: int
    location: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., type_id: _Optional[int] = ..., type_mod: _Optional[int] = ..., collation: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...
...
class CurrentOfExpr(_message.Message):
    ...
    cursor_name: str
    cursor_param: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., cvarno: _Optional[int] = ..., cursor_name: _Optional[str] = ..., cursor_param: _Optional[int] = ...) -> None: ...
...
class NextValueExpr(_message.Message):
    ...
    seqid: int
    type_id: int
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., seqid: _Optional[int] = ..., type_id: _Optional[int] = ...) -> None: ...
...
class TargetEntry(_message.Message):
    ...
    resorigcol: int
    resjunk: bool
    def __init__(self, xpr: _Optional[_Union[Node, _Mapping]] = ..., expr: _Optional[_Union[Node, _Mapping]] = ..., resno: _Optional[int] = ..., resname: _Optional[str] = ..., ressortgroupref: _Optional[int] = ..., resorigtbl: _Optional[int] = ..., resorigcol: _Optional[int] = ..., resjunk: bool = ...) -> None: ...
...
class FromExpr(_message.Message):
    ...
    quals: Node
    def __init__(self, fromlist: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., quals: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...

class OnConflictExpr(_message.Message):
    __slots__ = ("action", "arbiter_elems", "arbiter_where", "constraint", "on_conflict_set", "on_conflict_where", "excl_rel_index", "excl_rel_tlist")
...
class Query(_message.Message):
    ...
    MERGE_TARGET_RELATION_FIELD_NUMBER: _ClassVar[int]
    MERGE_JOIN_CONDITION_FIELD_NUMBER: _ClassVar[int]
    TARGET_LIST_FIELD_NUMBER: _ClassVar[int]
    OVERRIDE_FIELD_NUMBER: _ClassVar[int]
...
class TypeName(_message.Message):
    ...
    location: int
    def __init__(self, names: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., type_oid: _Optional[int] = ..., setof: bool = ..., pct_type: bool = ..., typmods: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., typemod: _Optional[int] = ..., array_bounds: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class ColumnRef(_message.Message):
    ...
    location: int
    def __init__(self, fields: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class TypeCast(_message.Message):
    ...
    type_name: TypeName
    location: int
    def __init__(self, arg: _Optional[_Union[Node, _Mapping]] = ..., type_name: _Optional[_Union[TypeName, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class CollateClause(_message.Message):
    ...
    location: int
    def __init__(self, arg: _Optional[_Union[Node, _Mapping]] = ..., collname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class RoleSpec(_message.Message):
    ...
    rolename: str
    location: int
    def __init__(self, roletype: _Optional[_Union[RoleSpecType, str]] = ..., rolename: _Optional[str] = ..., location: _Optional[int] = ...) -> None: ...

class FuncCall(_message.Message):
    __slots__ = ("funcname", "args", "agg_order", "agg_filter", "over", "agg_within_group", "agg_star", "agg_distinct", "func_variadic", "funcformat", "location")
    ...
    funcformat: CoercionForm
    location: int
    def __init__(self, funcname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., agg_order: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., agg_filter: _Optional[_Union[Node, _Mapping]] = ..., over: _Optional[_Union[WindowDef, _Mapping]] = ..., agg_within_group: bool = ..., agg_star: bool = ..., agg_distinct: bool = ..., func_variadic: bool = ..., funcformat: _Optional[_Union[CoercionForm, str]] = ..., location: _Optional[int] = ...) -> None: ...
...
class A_Indices(_message.Message):
    ...
    lidx: Node
    uidx: Node
    def __init__(self, is_slice: bool = ..., lidx: _Optional[_Union[Node, _Mapping]] = ..., uidx: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...
...
class ResTarget(_message.Message):
    ...
    val: Node
    location: int
    def __init__(self, name: _Optional[str] = ..., indirection: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., val: _Optional[_Union[Node, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class MultiAssignRef(_message.Message):
    ...
    colno: int
    ncolumns: int
    def __init__(self, source: _Optional[_Union[Node, _Mapping]] = ..., colno: _Optional[int] = ..., ncolumns: _Optional[int] = ...) -> None: ...
...
class SortBy(_message.Message):
    ...
    location: int
    def __init__(self, node: _Optional[_Union[Node, _Mapping]] = ..., sortby_dir: _Optional[_Union[SortByDir, str]] = ..., sortby_nulls: _Optional[_Union[SortByNulls, str]] = ..., use_op: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...

class WindowDef(_message.Message):
    __slots__ = ("name", "refname", "partition_clause", "order_clause", "frame_options", "start_offset", "end_offset", "location")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    end_offset: Node
    location: int
    def __init__(self, name: _Optional[str] = ..., refname: _Optional[str] = ..., partition_clause: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., order_clause: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., frame_options: _Optional[int] = ..., start_offset: _Optional[_Union[Node, _Mapping]] = ..., end_offset: _Optional[_Union[Node, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class RangeSubselect(_message.Message):
    ...
    subquery: Node
    alias: Alias
    def __init__(self, lateral: bool = ..., subquery: _Optional[_Union[Node, _Mapping]] = ..., alias: _Optional[_Union[Alias, _Mapping]] = ...) -> None: ...
...
class RangeFunction(_message.Message):
    ...
    def __init__(self, lateral: bool = ..., ordinality: bool = ..., is_rowsfrom: bool = ..., functions: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., alias: _Optional[_Union[Alias, _Mapping]] = ..., coldeflist: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class RangeTableFunc(_message.Message):
    ...
    alias: Alias
    location: int
    def __init__(self, lateral: bool = ..., docexpr: _Optional[_Union[Node, _Mapping]] = ..., rowexpr: _Optional[_Union[Node, _Mapping]] = ..., namespaces: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., columns: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., alias: _Optional[_Union[Alias, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class RangeTableFuncCol(_message.Message):
    ...
    coldefexpr: Node
    location: int
    def __init__(self, colname: _Optional[str] = ..., type_name: _Optional[_Union[TypeName, _Mapping]] = ..., for_ordinality: bool = ..., is_not_null: bool = ..., colexpr: _Optional[_Union[Node, _Mapping]] = ..., coldefexpr: _Optional[_Union[Node, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class RangeTableSample(_message.Message):
    ...
    repeatable: Node
    location: int
    def __init__(self, relation: _Optional[_Union[Node, _Mapping]] = ..., method: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., repeatable: _Optional[_Union[Node, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...

class ColumnDef(_message.Message):
    __slots__ = ("colname", "type_name", "compression", "inhcount", "is_local", "is_not_null", "is_from_type", "storage", "storage_name", "raw_default", "cooked_default", "identity", "identity_sequence", "generated", "coll_clause", "coll_oid", "constraints", "fdwoptions", "location")
    COLNAME_FIELD_NUMBER: _ClassVar[int]
    TYPE_NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    location: int
    def __init__(self, colname: _Optional[str] = ..., type_name: _Optional[_Union[TypeName, _Mapping]] = ..., compression: _Optional[str] = ..., inhcount: _Optional[int] = ..., is_local: bool = ..., is_not_null: bool = ..., is_from_type: bool = ..., storage: _Optional[str] = ..., storage_name: _Optional[str] = ..., raw_default: _Optional[_Union[Node, _Mapping]] = ..., cooked_default: _Optional[_Union[Node, _Mapping]] = ..., identity: _Optional[str] = ..., identity_sequence: _Optional[_Union[RangeVar, _Mapping]] = ..., generated: _Optional[str] = ..., coll_clause: _Optional[_Union[CollateClause, _Mapping]] = ..., coll_oid: _Optional[int] = ..., constraints: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., fdwoptions: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class TableLikeClause(_message.Message):
    ...
    options: int
    relation_oid: int
    def __init__(self, relation: _Optional[_Union[RangeVar, _Mapping]] = ..., options: _Optional[int] = ..., relation_oid: _Optional[int] = ...) -> None: ...
...
class IndexElem(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., expr: _Optional[_Union[Node, _Mapping]] = ..., indexcolname: _Optional[str] = ..., collation: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., opclass: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., opclassopts: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., ordering: _Optional[_Union[SortByDir, str]] = ..., nulls_ordering: _Optional[_Union[SortByNulls, str]] = ...) -> None: ...
...
class DefElem(_message.Message):
    ...
    location: int
    def __init__(self, defnamespace: _Optional[str] = ..., defname: _Optional[str] = ..., arg: _Optional[_Union[Node, _Mapping]] = ..., defaction: _Optional[_Union[DefElemAction, str]] = ..., location: _Optional[int] = ...) -> None: ...
...
class LockingClause(_message.Message):
    ...
    def __init__(self, locked_rels: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., strength: _Optional[_Union[LockClauseStrength, str]] = ..., wait_policy: _Optional[_Union[LockWaitPolicy, str]] = ...) -> None: ...
...
class XmlSerialize(_message.Message):
    ...
    indent: bool
    location: int
    def __init__(self, xmloption: _Optional[_Union[XmlOptionType, str]] = ..., expr: _Optional[_Union[Node, _Mapping]] = ..., type_name: _Optional[_Union[TypeName, _Mapping]] = ..., indent: bool = ..., location: _Optional[int] = ...) -> None: ...
...
class PartitionElem(_message.Message):
    ...
    opclass: _containers.RepeatedCompositeFieldContainer[Node]
    location: int
    def __init__(self, name: _Optional[str] = ..., expr: _Optional[_Union[Node, _Mapping]] = ..., collation: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., opclass: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class PartitionSpec(_message.Message):
    ...
    location: int
    def __init__(self, strategy: _Optional[_Union[PartitionStrategy, str]] = ..., part_params: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...

class PartitionBoundSpec(_message.Message):
    __slots__ = ("strategy", "is_default", "modulus", "remainder", "listdatums", "lowerdatums", "upperdatums", "location")
    STRATEGY_FIELD_NUMBER: _ClassVar[int]
    ...
    location: int
    def __init__(self, strategy: _Optional[str] = ..., is_default: bool = ..., modulus: _Optional[int] = ..., remainder: _Optional[int] = ..., listdatums: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., lowerdatums: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., upperdatums: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...
...
class RangeTblFunction(_message.Message):
    ...
    def __init__(self, funcexpr: _Optional[_Union[Node, _Mapping]] = ..., funccolcount: _Optional[int] = ..., funccolnames: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., funccoltypes: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., funccoltypmods: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., funccolcollations: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., funcparams: _Optional[_Iterable[int]] = ...) -> None: ...
...
class TableSampleClause(_message.Message):
    ...
    args: _containers.RepeatedCompositeFieldContainer[Node]
    repeatable: Node
    def __init__(self, tsmhandler: _Optional[int] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., repeatable: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...
...
class GroupingSet(_message.Message):
    ...
    location: int
    def __init__(self, kind: _Optional[_Union[GroupingSetKind, str]] = ..., content: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., location: _Optional[int] = ...) -> None: ...

class WindowClause(_message.Message):
    __slots__ = ("name", "refname", "partition_clause", "order_clause", "frame_options", "start_offset", "end_offset", "start_in_range_func", "end_in_range_func", "in_range_coll", "in_range_asc", "in_range_nulls_first", "winref", "copied_order")
    NAME_FIELD_NUMBER: _ClassVar[int]
    REFNAME_FIELD_NUMBER: _ClassVar[int]
    PARTITION_CLAUSE_FIELD_NUMBER: _ClassVar[int]
    ORDER_CLAUSE_FIELD_NUMBER: _ClassVar[int]
    ...
    winref: int
    copied_order: bool
    def __init__(self, name: _Optional[str] = ..., refname: _Optional[str] = ..., partition_clause: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., order_clause: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., frame_options: _Optional[int] = ..., start_offset: _Optional[_Union[Node, _Mapping]] = ..., end_offset: _Optional[_Union[Node, _Mapping]] = ..., start_in_range_func: _Optional[int] = ..., end_in_range_func: _Optional[int] = ..., in_range_coll: _Optional[int] = ..., in_range_asc: bool = ..., in_range_nulls_first: bool = ..., winref: _Optional[int] = ..., copied_order: bool = ...) -> None: ...
...
class RowMarkClause(_message.Message):
    ...
    wait_policy: LockWaitPolicy
    pushed_down: bool
    def __init__(self, rti: _Optional[int] = ..., strength: _Optional[_Union[LockClauseStrength, str]] = ..., wait_policy: _Optional[_Union[LockWaitPolicy, str]] = ..., pushed_down: bool = ...) -> None: ...
...
class WithClause(_message.Message):
    ...
    recursive: bool
    location: int
    def __init__(self, ctes: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., recursive: bool = ..., location: _Optional[int] = ...) -> None: ...
...
class InferClause(_message.Message):
    ...
    conname: str
    location: int
    def __init__(self, index_elems: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., where_clause: _Optional[_Union[Node, _Mapping]] = ..., conname: _Optional[str] = ..., location: _Optional[int] = ...) -> None: ...
...
class OnConflictClause(_message.Message):
    ...
    where_clause: Node
    location: int
    def __init__(self, action: _Optional[_Union[OnConflictAction, str]] = ..., infer: _Optional[_Union[InferClause, _Mapping]] = ..., target_list: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., where_clause: _Optional[_Union[Node, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class CTESearchClause(_message.Message):
    ...
    location: int
    def __init__(self, search_col_list: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., search_breadth_first: bool = ..., search_seq_column: _Optional[str] = ..., location: _Optional[int] = ...) -> None: ...

class CTECycleClause(_message.Message):
    __slots__ = ("cycle_col_list", "cycle_mark_column", "cycle_mark_value", "cycle_mark_default", "cycle_path_column", "location", "cycle_mark_type", "cycle_mark_typmod", "cycle_mark_collation", "cycle_mark_neop")
    ...
    cycle_mark_neop: int
    def __init__(self, cycle_col_list: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., cycle_mark_column: _Optional[str] = ..., cycle_mark_value: _Optional[_Union[Node, _Mapping]] = ..., cycle_mark_default: _Optional[_Union[Node, _Mapping]] = ..., cycle_path_column: _Optional[str] = ..., location: _Optional[int] = ..., cycle_mark_type: _Optional[int] = ..., cycle_mark_typmod: _Optional[int] = ..., cycle_mark_collation: _Optional[int] = ..., cycle_mark_neop: _Optional[int] = ...) -> None: ...

class CommonTableExpr(_message.Message):
    __slots__ = ("ctename", "aliascolnames", "ctematerialized", "ctequery", "search_clause", "cycle_clause", "location", "cterecursive", "cterefcount", "ctecolnames", "ctecoltypes", "ctecoltypmods", "ctecolcollations")
    CTENAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, ctename: _Optional[str] = ..., aliascolnames: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., ctematerialized: _Optional[_Union[CTEMaterialize, str]] = ..., ctequery: _Optional[_Union[Node, _Mapping]] = ..., search_clause: _Optional[_Union[CTESearchClause, _Mapping]] = ..., cycle_clause: _Optional[_Union[CTECycleClause, _Mapping]] = ..., location: _Optional[int] = ..., cterecursive: bool = ..., cterefcount: _Optional[int] = ..., ctecolnames: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., ctecoltypes: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., ctecoltypmods: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., ctecolcollations: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...

class MergeWhenClause(_message.Message):
    __slots__ = ("match_kind", "command_type", "override", "condition", "target_list", "values")
    MATCH_KIND_FIELD_NUMBER: _ClassVar[int]
    COMMAND_TYPE_FIELD_NUMBER: _ClassVar[int]
    OVERRIDE_FIELD_NUMBER: _ClassVar[int]
...
class JsonOutput(_message.Message):
    ...
    type_name: TypeName
    returning: JsonReturning
    def __init__(self, type_name: _Optional[_Union[TypeName, _Mapping]] = ..., returning: _Optional[_Union[JsonReturning, _Mapping]] = ...) -> None: ...

class JsonArgument(_message.Message):
    __slots__ = ("val", "name")
    VAL_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    val: JsonValueExpr
    name: str
    def __init__(self, val: _Optional[_Union[JsonValueExpr, _Mapping]] = ..., name: _Optional[str] = ...) -> None: ...

class JsonFuncExpr(_message.Message):
    __slots__ = ("op", "column_name", "context_item", "pathspec", "passing", "output", "on_empty", "on_error", "wrapper", "quotes", "location")
    OP_FIELD_NUMBER: _ClassVar[int]
    COLUMN_NAME_FIELD_NUMBER: _ClassVar[int]
    CONTEXT_ITEM_FIELD_NUMBER: _ClassVar[int]
    PATHSPEC_FIELD_NUMBER: _ClassVar[int]
    ...
    pathspec: Node
    passing: _containers.RepeatedCompositeFieldContainer[Node]
    output: JsonOutput
    on_empty: JsonBehavior
    on_error: JsonBehavior
    wrapper: JsonWrapper
    quotes: JsonQuotes
    location: int
    def __init__(self, op: _Optional[_Union[JsonExprOp, str]] = ..., column_name: _Optional[str] = ..., context_item: _Optional[_Union[JsonValueExpr, _Mapping]] = ..., pathspec: _Optional[_Union[Node, _Mapping]] = ..., passing: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., output: _Optional[_Union[JsonOutput, _Mapping]] = ..., on_empty: _Optional[_Union[JsonBehavior, _Mapping]] = ..., on_error: _Optional[_Union[JsonBehavior, _Mapping]] = ..., wrapper: _Optional[_Union[JsonWrapper, str]] = ..., quotes: _Optional[_Union[JsonQuotes, str]] = ..., location: _Optional[int] = ...) -> None: ...

class JsonTablePathSpec(_message.Message):
    __slots__ = ("string", "name", "name_location", "location")
    STRING_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    NAME_LOCATION_FIELD_NUMBER: _ClassVar[int]
    LOCATION_FIELD_NUMBER: _ClassVar[int]
    string: Node
    name: str
    name_location: int
    location: int
    def __init__(self, string: _Optional[_Union[Node, _Mapping]] = ..., name: _Optional[str] = ..., name_location: _Optional[int] = ..., location: _Optional[int] = ...) -> None: ...

class JsonTable(_message.Message):
    __slots__ = ("context_item", "pathspec", "passing", "columns", "on_error", "alias", "lateral", "location")
    CONTEXT_ITEM_FIELD_NUMBER: _ClassVar[int]
    PATHSPEC_FIELD_NUMBER: _ClassVar[int]
    PASSING_FIELD_NUMBER: _ClassVar[int]
    COLUMNS_FIELD_NUMBER: _ClassVar[int]
    ...
    lateral: bool
    location: int
    def __init__(self, context_item: _Optional[_Union[JsonValueExpr, _Mapping]] = ..., pathspec: _Optional[_Union[JsonTablePathSpec, _Mapping]] = ..., passing: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., columns: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., on_error: _Optional[_Union[JsonBehavior, _Mapping]] = ..., alias: _Optional[_Union[Alias, _Mapping]] = ..., lateral: bool = ..., location: _Optional[int] = ...) -> None: ...

class JsonTableColumn(_message.Message):
    __slots__ = ("coltype", "name", "type_name", "pathspec", "format", "wrapper", "quotes", "columns", "on_empty", "on_error", "location")
    COLTYPE_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    TYPE_NAME_FIELD_NUMBER: _ClassVar[int]
    PATHSPEC_FIELD_NUMBER: _ClassVar[int]
    FORMAT_FIELD_NUMBER: _ClassVar[int]
    ...
    on_error: JsonBehavior
    location: int
    def __init__(self, coltype: _Optional[_Union[JsonTableColumnType, str]] = ..., name: _Optional[str] = ..., type_name: _Optional[_Union[TypeName, _Mapping]] = ..., pathspec: _Optional[_Union[JsonTablePathSpec, _Mapping]] = ..., format: _Optional[_Union[JsonFormat, _Mapping]] = ..., wrapper: _Optional[_Union[JsonWrapper, str]] = ..., quotes: _Optional[_Union[JsonQuotes, str]] = ..., columns: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., on_empty: _Optional[_Union[JsonBehavior, _Mapping]] = ..., on_error: _Optional[_Union[JsonBehavior, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class JsonKeyValue(_message.Message):
    ...
    key: Node
    value: JsonValueExpr
    def __init__(self, key: _Optional[_Union[Node, _Mapping]] = ..., value: _Optional[_Union[JsonValueExpr, _Mapping]] = ...) -> None: ...

class JsonParseExpr(_message.Message):
    __slots__ = ("expr", "output", "unique_keys", "location")
    EXPR_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_FIELD_NUMBER: _ClassVar[int]
    UNIQUE_KEYS_FIELD_NUMBER: _ClassVar[int]
    LOCATION_FIELD_NUMBER: _ClassVar[int]
    ...
    unique_keys: bool
    location: int
    def __init__(self, expr: _Optional[_Union[JsonValueExpr, _Mapping]] = ..., output: _Optional[_Union[JsonOutput, _Mapping]] = ..., unique_keys: bool = ..., location: _Optional[int] = ...) -> None: ...

class JsonScalarExpr(_message.Message):
    __slots__ = ("expr", "output", "location")
    EXPR_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_FIELD_NUMBER: _ClassVar[int]
    LOCATION_FIELD_NUMBER: _ClassVar[int]
    expr: Node
    output: JsonOutput
    location: int
    def __init__(self, expr: _Optional[_Union[Node, _Mapping]] = ..., output: _Optional[_Union[JsonOutput, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...

class JsonSerializeExpr(_message.Message):
    __slots__ = ("expr", "output", "location")
    EXPR_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_FIELD_NUMBER: _ClassVar[int]
    LOCATION_FIELD_NUMBER: _ClassVar[int]
    ...
    output: JsonOutput
    location: int
    def __init__(self, expr: _Optional[_Union[JsonValueExpr, _Mapping]] = ..., output: _Optional[_Union[JsonOutput, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class JsonObjectConstructor(_message.Message):
    ...
    unique: bool
    location: int
    def __init__(self, exprs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., output: _Optional[_Union[JsonOutput, _Mapping]] = ..., absent_on_null: bool = ..., unique: bool = ..., location: _Optional[int] = ...) -> None: ...
...
class JsonArrayConstructor(_message.Message):
    ...
    absent_on_null: bool
    location: int
    def __init__(self, exprs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., output: _Optional[_Union[JsonOutput, _Mapping]] = ..., absent_on_null: bool = ..., location: _Optional[int] = ...) -> None: ...
...
class JsonArrayQueryConstructor(_message.Message):
    ...
    absent_on_null: bool
    location: int
    def __init__(self, query: _Optional[_Union[Node, _Mapping]] = ..., output: _Optional[_Union[JsonOutput, _Mapping]] = ..., format: _Optional[_Union[JsonFormat, _Mapping]] = ..., absent_on_null: bool = ..., location: _Optional[int] = ...) -> None: ...
...
class JsonAggConstructor(_message.Message):
    ...
    over: WindowDef
    location: int
    def __init__(self, output: _Optional[_Union[JsonOutput, _Mapping]] = ..., agg_filter: _Optional[_Union[Node, _Mapping]] = ..., agg_order: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., over: _Optional[_Union[WindowDef, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class JsonObjectAgg(_message.Message):
    ...
    absent_on_null: bool
    unique: bool
    def __init__(self, constructor: _Optional[_Union[JsonAggConstructor, _Mapping]] = ..., arg: _Optional[_Union[JsonKeyValue, _Mapping]] = ..., absent_on_null: bool = ..., unique: bool = ...) -> None: ...
...
class JsonArrayAgg(_message.Message):
    ...
    arg: JsonValueExpr
    absent_on_null: bool
    def __init__(self, constructor: _Optional[_Union[JsonAggConstructor, _Mapping]] = ..., arg: _Optional[_Union[JsonValueExpr, _Mapping]] = ..., absent_on_null: bool = ...) -> None: ...
...
class PLAssignStmt(_message.Message):
    ...
    val: SelectStmt
    location: int
    def __init__(self, name: _Optional[str] = ..., indirection: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., nnames: _Optional[int] = ..., val: _Optional[_Union[SelectStmt, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class CreateSchemaStmt(_message.Message):
    ...
    if_not_exists: bool
    def __init__(self, schemaname: _Optional[str] = ..., authrole: _Optional[_Union[RoleSpec, _Mapping]] = ..., schema_elts: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., if_not_exists: bool = ...) -> None: ...
...
class AlterDomainStmt(_message.Message):
    ...
    behavior: DropBehavior
    missing_ok: bool
    def __init__(self, subtype: _Optional[str] = ..., type_name: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., name: _Optional[str] = ..., behavior: _Optional[_Union[DropBehavior, str]] = ..., missing_ok: bool = ..., **kwargs) -> None: ...

class GrantStmt(_message.Message):
    __slots__ = ("is_grant", "targtype", "objtype", "objects", "privileges", "grantees", "grant_option", "grantor", "behavior")
    ...
    grantor: RoleSpec
    behavior: DropBehavior
    def __init__(self, is_grant: bool = ..., targtype: _Optional[_Union[GrantTargetType, str]] = ..., objtype: _Optional[_Union[ObjectType, str]] = ..., objects: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., privileges: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., grantees: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., grant_option: bool = ..., grantor: _Optional[_Union[RoleSpec, _Mapping]] = ..., behavior: _Optional[_Union[DropBehavior, str]] = ...) -> None: ...
...
class ObjectWithArgs(_message.Message):
    ...
    def __init__(self, objname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., objargs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., objfuncargs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., args_unspecified: bool = ...) -> None: ...
...
class AccessPriv(_message.Message):
    ...
    priv_name: str
    cols: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, priv_name: _Optional[str] = ..., cols: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class GrantRoleStmt(_message.Message):
    ...
    grantor: RoleSpec
    behavior: DropBehavior
    def __init__(self, granted_roles: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., grantee_roles: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., is_grant: bool = ..., opt: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., grantor: _Optional[_Union[RoleSpec, _Mapping]] = ..., behavior: _Optional[_Union[DropBehavior, str]] = ...) -> None: ...
...
class AlterDefaultPrivilegesStmt(_message.Message):
    ...
    options: _containers.RepeatedCompositeFieldContainer[Node]
    action: GrantStmt
    def __init__(self, options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., action: _Optional[_Union[GrantStmt, _Mapping]] = ...) -> None: ...
...
class CreateTableSpaceStmt(_message.Message):
    ...
    location: str
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, tablespacename: _Optional[str] = ..., owner: _Optional[_Union[RoleSpec, _Mapping]] = ..., location: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterTableSpaceOptionsStmt(_message.Message):
    ...
    options: _containers.RepeatedCompositeFieldContainer[Node]
    is_reset: bool
    def __init__(self, tablespacename: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., is_reset: bool = ...) -> None: ...
...
class AlterTableMoveAllStmt(_message.Message):
    ...
    nowait: bool
    def __init__(self, orig_tablespacename: _Optional[str] = ..., objtype: _Optional[_Union[ObjectType, str]] = ..., roles: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., new_tablespacename: _Optional[str] = ..., nowait: bool = ...) -> None: ...
...
class CreateExtensionStmt(_message.Message):
    ...
    if_not_exists: bool
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, extname: _Optional[str] = ..., if_not_exists: bool = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterExtensionStmt(_message.Message):
    ...
    extname: str
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, extname: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterExtensionContentsStmt(_message.Message):
    ...
    objtype: ObjectType
    object: Node
    def __init__(self, extname: _Optional[str] = ..., action: _Optional[int] = ..., objtype: _Optional[_Union[ObjectType, str]] = ..., object: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...
...
class CreateFdwStmt(_message.Message):
    ...
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, fdwname: _Optional[str] = ..., func_options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class CreateForeignServerStmt(_message.Message):
    ...
    if_not_exists: bool
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, servername: _Optional[str] = ..., servertype: _Optional[str] = ..., version: _Optional[str] = ..., fdwname: _Optional[str] = ..., if_not_exists: bool = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterForeignServerStmt(_message.Message):
    ...
    options: _containers.RepeatedCompositeFieldContainer[Node]
    has_version: bool
    def __init__(self, servername: _Optional[str] = ..., version: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., has_version: bool = ...) -> None: ...
...
class CreateForeignTableStmt(_message.Message):
    ...
    servername: str
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, base_stmt: _Optional[_Union[CreateStmt, _Mapping]] = ..., servername: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class CreateUserMappingStmt(_message.Message):
    ...
    if_not_exists: bool
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, user: _Optional[_Union[RoleSpec, _Mapping]] = ..., servername: _Optional[str] = ..., if_not_exists: bool = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterUserMappingStmt(_message.Message):
    ...
    servername: str
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, user: _Optional[_Union[RoleSpec, _Mapping]] = ..., servername: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class DropUserMappingStmt(_message.Message):
    ...
    servername: str
    missing_ok: bool
    def __init__(self, user: _Optional[_Union[RoleSpec, _Mapping]] = ..., servername: _Optional[str] = ..., missing_ok: bool = ...) -> None: ...
...
class ImportForeignSchemaStmt(_message.Message):
    ...
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, server_name: _Optional[str] = ..., remote_schema: _Optional[str] = ..., local_schema: _Optional[str] = ..., list_type: _Optional[_Union[ImportForeignSchemaType, str]] = ..., table_list: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class CreatePolicyStmt(_message.Message):
    ...
    qual: Node
    with_check: Node
    def __init__(self, policy_name: _Optional[str] = ..., table: _Optional[_Union[RangeVar, _Mapping]] = ..., cmd_name: _Optional[str] = ..., permissive: bool = ..., roles: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., qual: _Optional[_Union[Node, _Mapping]] = ..., with_check: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...
...
class AlterPolicyStmt(_message.Message):
    ...
    qual: Node
    with_check: Node
    def __init__(self, policy_name: _Optional[str] = ..., table: _Optional[_Union[RangeVar, _Mapping]] = ..., roles: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., qual: _Optional[_Union[Node, _Mapping]] = ..., with_check: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...
...
class CreateAmStmt(_message.Message):
    ...
    amtype: str
    def __init__(self, amname: _Optional[str] = ..., handler_name: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., amtype: _Optional[str] = ...) -> None: ...

class CreateTrigStmt(_message.Message):
    __slots__ = ("replace", "isconstraint", "trigname", "relation", "funcname", "args", "row", "timing", "events", "columns", "when_clause", "transition_rels", "deferrable", "initdeferred", "constrrel")
    ...
    initdeferred: bool
    constrrel: RangeVar
    def __init__(self, replace: bool = ..., isconstraint: bool = ..., trigname: _Optional[str] = ..., relation: _Optional[_Union[RangeVar, _Mapping]] = ..., funcname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., row: bool = ..., timing: _Optional[int] = ..., events: _Optional[int] = ..., columns: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., when_clause: _Optional[_Union[Node, _Mapping]] = ..., transition_rels: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., deferrable: bool = ..., initdeferred: bool = ..., constrrel: _Optional[_Union[RangeVar, _Mapping]] = ...) -> None: ...
...
class CreateEventTrigStmt(_message.Message):
    ...
    funcname: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, trigname: _Optional[str] = ..., eventname: _Optional[str] = ..., whenclause: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., funcname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class CreatePLangStmt(_message.Message):
    ...
    pltrusted: bool
    def __init__(self, replace: bool = ..., plname: _Optional[str] = ..., plhandler: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., plinline: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., plvalidator: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., pltrusted: bool = ...) -> None: ...
...
class CreateRoleStmt(_message.Message):
    ...
    role: str
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, stmt_type: _Optional[_Union[RoleStmtType, str]] = ..., role: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterRoleStmt(_message.Message):
    ...
    options: _containers.RepeatedCompositeFieldContainer[Node]
    action: int
    def __init__(self, role: _Optional[_Union[RoleSpec, _Mapping]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., action: _Optional[int] = ...) -> None: ...
...
class AlterRoleSetStmt(_message.Message):
    ...
    def __init__(self, role: _Optional[_Union[RoleSpec, _Mapping]] = ..., database: _Optional[str] = ..., setstmt: _Optional[_Union[VariableSetStmt, _Mapping]] = ...) -> None: ...
...
class CreateSeqStmt(_message.Message):
    ...
    for_identity: bool
    if_not_exists: bool
    def __init__(self, sequence: _Optional[_Union[RangeVar, _Mapping]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., owner_id: _Optional[int] = ..., for_identity: bool = ..., if_not_exists: bool = ...) -> None: ...
...
class AlterSeqStmt(_message.Message):
    ...
    for_identity: bool
    missing_ok: bool
    def __init__(self, sequence: _Optional[_Union[RangeVar, _Mapping]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., for_identity: bool = ..., missing_ok: bool = ...) -> None: ...
...
class DefineStmt(_message.Message):
    ...
    if_not_exists: bool
    replace: bool
    def __init__(self, kind: _Optional[_Union[ObjectType, str]] = ..., oldstyle: bool = ..., defnames: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., definition: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., if_not_exists: bool = ..., replace: bool = ...) -> None: ...
...
class CreateDomainStmt(_message.Message):
    ...
    coll_clause: CollateClause
    constraints: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, domainname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., type_name: _Optional[_Union[TypeName, _Mapping]] = ..., coll_clause: _Optional[_Union[CollateClause, _Mapping]] = ..., constraints: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class CreateOpClassStmt(_message.Message):
    ...
    items: _containers.RepeatedCompositeFieldContainer[Node]
    is_default: bool
    def __init__(self, opclassname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., opfamilyname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., amname: _Optional[str] = ..., datatype: _Optional[_Union[TypeName, _Mapping]] = ..., items: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., is_default: bool = ...) -> None: ...
...
class CreateOpClassItem(_message.Message):
    ...
    storedtype: TypeName
    def __init__(self, itemtype: _Optional[int] = ..., name: _Optional[_Union[ObjectWithArgs, _Mapping]] = ..., number: _Optional[int] = ..., order_family: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., class_args: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., storedtype: _Optional[_Union[TypeName, _Mapping]] = ...) -> None: ...
...
class CreateOpFamilyStmt(_message.Message):
    ...
    opfamilyname: _containers.RepeatedCompositeFieldContainer[Node]
    amname: str
    def __init__(self, opfamilyname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., amname: _Optional[str] = ...) -> None: ...
...
class AlterOpFamilyStmt(_message.Message):
    ...
    is_drop: bool
    items: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, opfamilyname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., amname: _Optional[str] = ..., is_drop: bool = ..., items: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class DropStmt(_message.Message):
    ...
    missing_ok: bool
    concurrent: bool
    def __init__(self, objects: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., remove_type: _Optional[_Union[ObjectType, str]] = ..., behavior: _Optional[_Union[DropBehavior, str]] = ..., missing_ok: bool = ..., concurrent: bool = ...) -> None: ...
...
class TruncateStmt(_message.Message):
    ...
    restart_seqs: bool
    behavior: DropBehavior
    def __init__(self, relations: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., restart_seqs: bool = ..., behavior: _Optional[_Union[DropBehavior, str]] = ...) -> None: ...
...
class CommentStmt(_message.Message):
    ...
    object: Node
    comment: str
    def __init__(self, objtype: _Optional[_Union[ObjectType, str]] = ..., object: _Optional[_Union[Node, _Mapping]] = ..., comment: _Optional[str] = ...) -> None: ...
...
class SecLabelStmt(_message.Message):
    ...
    provider: str
    label: str
    def __init__(self, objtype: _Optional[_Union[ObjectType, str]] = ..., object: _Optional[_Union[Node, _Mapping]] = ..., provider: _Optional[str] = ..., label: _Optional[str] = ...) -> None: ...
...
class DeclareCursorStmt(_message.Message):
    ...
    options: int
    query: Node
    def __init__(self, portalname: _Optional[str] = ..., options: _Optional[int] = ..., query: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...
...
class CreateStatsStmt(_message.Message):
    ...
    transformed: bool
    if_not_exists: bool
    def __init__(self, defnames: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., stat_types: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., exprs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., relations: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., stxcomment: _Optional[str] = ..., transformed: bool = ..., if_not_exists: bool = ...) -> None: ...
...
class AlterStatsStmt(_message.Message):
    ...
    stxstattarget: Node
    missing_ok: bool
    def __init__(self, defnames: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., stxstattarget: _Optional[_Union[Node, _Mapping]] = ..., missing_ok: bool = ...) -> None: ...
...
class AlterFunctionStmt(_message.Message):
    ...
    def __init__(self, objtype: _Optional[_Union[ObjectType, str]] = ..., func: _Optional[_Union[ObjectWithArgs, _Mapping]] = ..., actions: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class InlineCodeBlock(_message.Message):
    ...
    atomic: bool
    def __init__(self, source_text: _Optional[str] = ..., lang_oid: _Optional[int] = ..., lang_is_trusted: bool = ..., atomic: bool = ...) -> None: ...
...
class CallStmt(_message.Message):
    ...
    def __init__(self, funccall: _Optional[_Union[FuncCall, _Mapping]] = ..., funcexpr: _Optional[_Union[FuncExpr, _Mapping]] = ..., outargs: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class RenameStmt(_message.Message):
    ...
    behavior: DropBehavior
    missing_ok: bool
    def __init__(self, rename_type: _Optional[_Union[ObjectType, str]] = ..., relation_type: _Optional[_Union[ObjectType, str]] = ..., relation: _Optional[_Union[RangeVar, _Mapping]] = ..., object: _Optional[_Union[Node, _Mapping]] = ..., subname: _Optional[str] = ..., newname: _Optional[str] = ..., behavior: _Optional[_Union[DropBehavior, str]] = ..., missing_ok: bool = ...) -> None: ...
...
class AlterObjectDependsStmt(_message.Message):
    ...
    extname: String
    remove: bool
    def __init__(self, object_type: _Optional[_Union[ObjectType, str]] = ..., relation: _Optional[_Union[RangeVar, _Mapping]] = ..., object: _Optional[_Union[Node, _Mapping]] = ..., extname: _Optional[_Union[String, _Mapping]] = ..., remove: bool = ...) -> None: ...
...
class AlterObjectSchemaStmt(_message.Message):
    ...
    newschema: str
    missing_ok: bool
    def __init__(self, object_type: _Optional[_Union[ObjectType, str]] = ..., relation: _Optional[_Union[RangeVar, _Mapping]] = ..., object: _Optional[_Union[Node, _Mapping]] = ..., newschema: _Optional[str] = ..., missing_ok: bool = ...) -> None: ...
...
class AlterOwnerStmt(_message.Message):
    ...
    object: Node
    newowner: RoleSpec
    def __init__(self, object_type: _Optional[_Union[ObjectType, str]] = ..., relation: _Optional[_Union[RangeVar, _Mapping]] = ..., object: _Optional[_Union[Node, _Mapping]] = ..., newowner: _Optional[_Union[RoleSpec, _Mapping]] = ...) -> None: ...
...
class AlterOperatorStmt(_message.Message):
    ...
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, opername: _Optional[_Union[ObjectWithArgs, _Mapping]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterTypeStmt(_message.Message):
    ...
    type_name: _containers.RepeatedCompositeFieldContainer[Node]
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, type_name: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class RuleStmt(_message.Message):
    ...
    actions: _containers.RepeatedCompositeFieldContainer[Node]
    replace: bool
    def __init__(self, relation: _Optional[_Union[RangeVar, _Mapping]] = ..., rulename: _Optional[str] = ..., where_clause: _Optional[_Union[Node, _Mapping]] = ..., event: _Optional[_Union[CmdType, str]] = ..., instead: bool = ..., actions: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., replace: bool = ...) -> None: ...
...
class TransactionStmt(_message.Message):
    __slots__ = ("kind", "options", "savepoint_name", "gid", "chain", "location")
    KIND_FIELD_NUMBER: _ClassVar[int]
    OPTIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    chain: bool
    location: int
    def __init__(self, kind: _Optional[_Union[TransactionStmtKind, str]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., savepoint_name: _Optional[str] = ..., gid: _Optional[str] = ..., chain: bool = ..., location: _Optional[int] = ...) -> None: ...
...
class CompositeTypeStmt(_message.Message):
    ...
    typevar: RangeVar
    coldeflist: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, typevar: _Optional[_Union[RangeVar, _Mapping]] = ..., coldeflist: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class CreateEnumStmt(_message.Message):
    ...
    def __init__(self, type_name: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., vals: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class CreateRangeStmt(_message.Message):
    ...
    def __init__(self, type_name: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., params: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterEnumStmt(_message.Message):
    ...
    def __init__(self, type_name: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., old_val: _Optional[str] = ..., new_val: _Optional[str] = ..., new_val_neighbor: _Optional[str] = ..., new_val_is_after: bool = ..., skip_if_new_val_exists: bool = ...) -> None: ...
...
class ViewStmt(_message.Message):
    ...
    def __init__(self, view: _Optional[_Union[RangeVar, _Mapping]] = ..., aliases: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., query: _Optional[_Union[Node, _Mapping]] = ..., replace: bool = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., with_check_option: _Optional[_Union[ViewCheckOption, str]] = ...) -> None: ...
...
class CreatedbStmt(_message.Message):
    ...
    dbname: str
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, dbname: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterDatabaseSetStmt(_message.Message):
    ...
    dbname: str
    setstmt: VariableSetStmt
    def __init__(self, dbname: _Optional[str] = ..., setstmt: _Optional[_Union[VariableSetStmt, _Mapping]] = ...) -> None: ...
...
class DropdbStmt(_message.Message):
    ...
    missing_ok: bool
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, dbname: _Optional[str] = ..., missing_ok: bool = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class ClusterStmt(_message.Message):
    ...
    indexname: str
    params: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, relation: _Optional[_Union[RangeVar, _Mapping]] = ..., indexname: _Optional[str] = ..., params: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class VacuumStmt(_message.Message):
    ...
    is_vacuumcmd: bool
    def __init__(self, options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., rels: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., is_vacuumcmd: bool = ...) -> None: ...
...
class VacuumRelation(_message.Message):
    ...
    def __init__(self, relation: _Optional[_Union[RangeVar, _Mapping]] = ..., oid: _Optional[int] = ..., va_cols: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class ExplainStmt(_message.Message):
    ...
    query: Node
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, query: _Optional[_Union[Node, _Mapping]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class CreateTableAsStmt(_message.Message):
    ...
    is_select_into: bool
    if_not_exists: bool
    def __init__(self, query: _Optional[_Union[Node, _Mapping]] = ..., into: _Optional[_Union[IntoClause, _Mapping]] = ..., objtype: _Optional[_Union[ObjectType, str]] = ..., is_select_into: bool = ..., if_not_exists: bool = ...) -> None: ...
...
class RefreshMatViewStmt(_message.Message):
    ...
    skip_data: bool
    relation: RangeVar
    def __init__(self, concurrent: bool = ..., skip_data: bool = ..., relation: _Optional[_Union[RangeVar, _Mapping]] = ...) -> None: ...
...
class LockStmt(_message.Message):
    ...
    mode: int
    nowait: bool
    def __init__(self, relations: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., mode: _Optional[int] = ..., nowait: bool = ...) -> None: ...
...
class ConstraintsSetStmt(_message.Message):
    ...
    constraints: _containers.RepeatedCompositeFieldContainer[Node]
    deferred: bool
    def __init__(self, constraints: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., deferred: bool = ...) -> None: ...
...
class ReindexStmt(_message.Message):
    ...
    name: str
    params: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, kind: _Optional[_Union[ReindexObjectType, str]] = ..., relation: _Optional[_Union[RangeVar, _Mapping]] = ..., name: _Optional[str] = ..., params: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class CreateConversionStmt(_message.Message):
    ...
    def __init__(self, conversion_name: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., for_encoding_name: _Optional[str] = ..., to_encoding_name: _Optional[str] = ..., func_name: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., **kwargs) -> None: ...
...
class CreateCastStmt(_message.Message):
    ...
    inout: bool
    def __init__(self, sourcetype: _Optional[_Union[TypeName, _Mapping]] = ..., targettype: _Optional[_Union[TypeName, _Mapping]] = ..., func: _Optional[_Union[ObjectWithArgs, _Mapping]] = ..., context: _Optional[_Union[CoercionContext, str]] = ..., inout: bool = ...) -> None: ...
...
class CreateTransformStmt(_message.Message):
    ...
    def __init__(self, replace: bool = ..., type_name: _Optional[_Union[TypeName, _Mapping]] = ..., lang: _Optional[str] = ..., fromsql: _Optional[_Union[ObjectWithArgs, _Mapping]] = ..., tosql: _Optional[_Union[ObjectWithArgs, _Mapping]] = ...) -> None: ...
...
class PrepareStmt(_message.Message):
    ...
    query: Node
    def __init__(self, name: _Optional[str] = ..., argtypes: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., query: _Optional[_Union[Node, _Mapping]] = ...) -> None: ...
...
class ExecuteStmt(_message.Message):
    ...
    name: str
    params: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, name: _Optional[str] = ..., params: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...

class DeallocateStmt(_message.Message):
    __slots__ = ("name", "isall", "location")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ISALL_FIELD_NUMBER: _ClassVar[int]
    LOCATION_FIELD_NUMBER: _ClassVar[int]
    name: str
    isall: bool
    location: int
    def __init__(self, name: _Optional[str] = ..., isall: bool = ..., location: _Optional[int] = ...) -> None: ...
...
class DropOwnedStmt(_message.Message):
    ...
    roles: _containers.RepeatedCompositeFieldContainer[Node]
    behavior: DropBehavior
    def __init__(self, roles: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., behavior: _Optional[_Union[DropBehavior, str]] = ...) -> None: ...
...
class ReassignOwnedStmt(_message.Message):
    ...
    roles: _containers.RepeatedCompositeFieldContainer[Node]
    newrole: RoleSpec
    def __init__(self, roles: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., newrole: _Optional[_Union[RoleSpec, _Mapping]] = ...) -> None: ...
...
class AlterTSDictionaryStmt(_message.Message):
    ...
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, dictname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterTSConfigurationStmt(_message.Message):
    ...
    replace: bool
    missing_ok: bool
    def __init__(self, kind: _Optional[_Union[AlterTSConfigType, str]] = ..., cfgname: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., tokentype: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., dicts: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., override: bool = ..., replace: bool = ..., missing_ok: bool = ...) -> None: ...
...
class PublicationTable(_message.Message):
    ...
    where_clause: Node
    columns: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, relation: _Optional[_Union[RangeVar, _Mapping]] = ..., where_clause: _Optional[_Union[Node, _Mapping]] = ..., columns: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class PublicationObjSpec(_message.Message):
    ...
    location: int
    def __init__(self, pubobjtype: _Optional[_Union[PublicationObjSpecType, str]] = ..., name: _Optional[str] = ..., pubtable: _Optional[_Union[PublicationTable, _Mapping]] = ..., location: _Optional[int] = ...) -> None: ...
...
class CreatePublicationStmt(_message.Message):
    ...
    for_all_tables: bool
    def __init__(self, pubname: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., pubobjects: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., for_all_tables: bool = ...) -> None: ...
...
class AlterPublicationStmt(_message.Message):
    ...
    def __init__(self, pubname: _Optional[str] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., pubobjects: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., for_all_tables: bool = ..., action: _Optional[_Union[AlterPublicationAction, str]] = ...) -> None: ...
...
class CreateSubscriptionStmt(_message.Message):
    ...
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, subname: _Optional[str] = ..., conninfo: _Optional[str] = ..., publication: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class AlterSubscriptionStmt(_message.Message):
    ...
    publication: _containers.RepeatedCompositeFieldContainer[Node]
    options: _containers.RepeatedCompositeFieldContainer[Node]
    def __init__(self, kind: _Optional[_Union[AlterSubscriptionType, str]] = ..., subname: _Optional[str] = ..., conninfo: _Optional[str] = ..., publication: _Optional[_Iterable[_Union[Node, _Mapping]]] = ..., options: _Optional[_Iterable[_Union[Node, _Mapping]]] = ...) -> None: ...
...
class DropSubscriptionStmt(_message.Message):
    ...
    missing_ok: bool
    behavior: DropBehavior
    def __init__(self, subname: _Optional[str] = ..., missing_ok: bool = ..., behavior: _Optional[_Union[DropBehavior, str]] = ...) -> None: ...
...
class ScanToken(_message.Message):
    ...
    def __init__(self, start: _Optional[int] = ..., end: _Optional[int] = ..., token: _Optional[_Union[Token, str]] = ..., keyword_kind: _Optional[_Union[KeywordKind, str]] = ...) -> None: ...

class SummaryResult(_message.Message):
    __slots__ = ("tables", "aliases", "cte_names", "functions", "filter_columns", "statement_types", "truncated_query")
    class Context(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        None: _ClassVar[SummaryResult.Context]
        Select: _ClassVar[SummaryResult.Context]
        DML: _ClassVar[SummaryResult.Context]
        DDL: _ClassVar[SummaryResult.Context]
        Call: _ClassVar[SummaryResult.Context]
    None: SummaryResult.Context
    Select: SummaryResult.Context
    DML: SummaryResult.Context
    DDL: SummaryResult.Context
    Call: SummaryResult.Context
    class Table(_message.Message):
        __slots__ = ("name", "schema_name", "table_name", "context")
        NAME_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, name: _Optional[str] = ..., schema_name: _Optional[str] = ..., table_name: _Optional[str] = ..., context: _Optional[_Union[SummaryResult.Context, str]] = ...) -> None: ...
    ...
    class Function(_message.Message):
        __slots__ = ("name", "function_name", "schema_name", "context")
        NAME_FIELD_NUMBER: _ClassVar[int]
        ...
        schema_name: str
        context: SummaryResult.Context
        def __init__(self, name: _Optional[str] = ..., function_name: _Optional[str] = ..., schema_name: _Optional[str] = ..., context: _Optional[_Union[SummaryResult.Context, str]] = ...) -> None: ...
    class FilterColumn(_message.Message):
        __slots__ = ("schema_name", "table_name", "column")
        SCHEMA_NAME_FIELD_NUMBER: _ClassVar[int]
        TABLE_NAME_FIELD_NUMBER: _ClassVar[int]
        ...
        table_name: str
        column: str
        def __init__(self, schema_name: _Optional[str] = ..., table_name: _Optional[str] = ..., column: _Optional[str] = ...) -> None: ...
    TABLES_FIELD_NUMBER: _ClassVar[int]
    ALIASES_FIELD_NUMBER: _ClassVar[int]
    CTE_NAMES_FIELD_NUMBER: _ClassVar[int]
    FUNCTIONS_FIELD_NUMBER: _ClassVar[int]
    FILTER_COLUMNS_FIELD_NUMBER: _ClassVar[int]
    STATEMENT_TYPES_FIELD_NUMBER: _ClassVar[int]
    TRUNCATED_QUERY_FIELD_NUMBER: _ClassVar[int]
    tables: _containers.RepeatedCompositeFieldContainer[SummaryResult.Table]
    aliases: _containers.ScalarMap[str, str]
    cte_names: _containers.RepeatedScalarFieldContainer[str]
    functions: _containers.RepeatedCompositeFieldContainer[SummaryResult.Function]
    filter_columns: _containers.RepeatedCompositeFieldContainer[SummaryResult.FilterColumn]
    statement_types: _containers.RepeatedScalarFieldContainer[str]
    truncated_query: str
    def __init__(self, tables: _Optional[_Iterable[_Union[SummaryResult.Table, _Mapping]]] = ..., aliases: _Optional[_Mapping[str, str]] = ..., cte_names: _Optional[_Iterable[str]] = ..., functions: _Optional[_Iterable[_Union[SummaryResult.Function, _Mapping]]] = ..., filter_columns: _Optional[_Iterable[_Union[SummaryResult.FilterColumn, _Mapping]]] = ..., statement_types: _Optional[_Iterable[str]] = ..., truncated_query: _Optional[str] = ...) -> None: ...
